...
- Name: TestCase12.test.ts >> Testcase 11 - Verify Subscription in Cart page
- Location: tests\TestCase12.test.ts:3:5

# Error details

```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: locator('//div[@class = \'single-products\'][1]') resolved to 40 elements:
