...
- Name: TestMUAI.test.ts >> Test Case 6
- Location: tests\TestMUAI.test.ts:103:5
...
Expected substring: "You have entered 'Vignesh' !"
Received string:    ""
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//p[@id = \'prompt-demo\']')
    7 × locator resolved to <p id="prompt-demo" class="ml-10 mb-20 mt-20"></p>
      - unexpected value ""
