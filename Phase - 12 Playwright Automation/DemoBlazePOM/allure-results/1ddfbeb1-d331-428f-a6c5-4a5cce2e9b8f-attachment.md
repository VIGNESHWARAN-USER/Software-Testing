...
```ts
  ...
  26 |     }
  27 | 
  28 |     async openContactPage() {
  29 |         await this.contactNavOption.click();
  30 |     }
  31 |     
  32 |     async openLoginPage() {
> 33 |         await this.loginNavOption.click();
     |                                   ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  34 |     }
  35 | 
  36 |     async openSamsungGalaxyS6() {
  37 |         await this.samsungGalaxyS6.click();
  38 |     }
  39 | 
  40 | }
```