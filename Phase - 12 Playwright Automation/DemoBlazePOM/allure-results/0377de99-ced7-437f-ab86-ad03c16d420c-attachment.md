...
- Name: Contact.test.ts >> Contact Tests >> Test without message
- Location: tests\Contact.test.ts:11:17
...
Call log:
  - waiting for locator('//a[text()="Contact"]')
    - locator resolved to <a href="#" class="nav-link" data-toggle="modal" data-target="#exampleModal">Contact</a>
...
```ts
  ...
  13 |         this.page = page;
  14 |         this.loginNavOption = page.getByRole('link', { name: 'Log in' });
  15 |         this.logoutNavOption = page.getByRole('link', { name: 'Log out' });
  16 |         this.nameNavOption = page.locator('#nameofuser')
  17 |         this.contactNavOption = page.locator('//a[text()="Contact"]');
  18 |     }
  19 | 
  20 |     async navigate() {
  ...
  22 |     }
  23 | 
  24 |     async openContactPage() {
> 25 |         await this.contactNavOption.click();
     |                                     ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  26 |     }
  27 |     
  28 |     async openLoginPage() {
  29 |         await this.loginNavOption.click();
  30 |     }
  31 | 
  32 | }
```